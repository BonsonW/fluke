...
def compile_fp8_per_token_quantize(*, K: int):
    ...
    def launch_fp8_per_token_quantize(
        ...
        c1 = 1
        # Emit the `memref.global @smem_storage` backing the LDS reduction buffer into the
        # gpu.module (without this the traced get_global has no target and verify fails).
